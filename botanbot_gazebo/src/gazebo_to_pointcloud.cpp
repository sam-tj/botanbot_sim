...
namespace gazebo
{
    ...
    sdf::ElementPtr _sdf)
  {
    ...
    auto service_callback = [this](
      const std::shared_ptr<vox_nav_msgs::srv::GetPointCloud::Request> req,
      std::shared_ptr<vox_nav_msgs::srv::GetPointCloud::Response> res)
      {
    ...
    srv_ = node_->create_service<vox_nav_msgs::srv::GetPointCloud>(service_name, service_callback);
  }
  ...
  void PointCloudFromGazeboWorld::CreatePointCloud(
    const vox_nav_msgs::srv::GetPointCloud::Request & msg)
  {
