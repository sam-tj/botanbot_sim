...
namespace gazebo_plugins
{
  ...
  void botanbotAckermannDrive::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
  {
    ...
    impl_->joints_[botanbotAckermannDrivePrivate::FRONT_RIGHT] =
      _model->GetJoint(front_right_joint);
  ...
  void botanbotAckermannDrivePrivate::UpdateOdometryWorld()
  {
    ...
    distance_.data +=
      hypot(prev_x - odom_.pose.pose.position.x, prev_y - odom_.pose.pose.position.y);
